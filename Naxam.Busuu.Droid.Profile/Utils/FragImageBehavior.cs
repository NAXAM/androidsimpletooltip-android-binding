...
{
    [Register("Naxam.Busuu.Droid.Profile.Utils.FragImageBehavior")]
    public class FragImageBehavior : CoordinatorLayout.Behavior
    {
        ...
        public FragImageBehavior(Context context, IAttributeSet attrs)
        {
            mContext = context;
        ...
        {
            mAvatarMaxSize = mContext.Resources.GetDimension(Resource.Dimension.image_width);
        }
